				...
				<div class="row totalResult">
					<div class="col-4 white" align="center">
						<div class="form-group">
							<span style="color: white;">{{ $OwnTotalAffiliate }}</span><br>
							<span style="color: white;">Total Team</span>
						</div>
					</div>
					<div class="col-4 white" align="center">
						<div class="form-group">
							<span style="color: white;">{{ $OwnAffiliate }}</span><br>
							<span style="color: white;">Downline</span>
						</div>
					</div>
					<div class="col-4 white" align="center">
						<div class="form-group">
							<span style="color: white;">{{ $GetSelectedUserDailyTotalAffiliates }}</span><br>
				...
				<ul>
					@if(!$affiliates->isEmpty())
						@foreach($affiliates as $affiliate)
							<li>
								@if($code != Auth::user()->code && Auth::guard('merchant')->check())
									<a>
										<div class="users-details-box">
											...
											<div class="users-details-box">
													...
													Daily: {{ $TodayTotalAffiliates[$affiliate->code] }}
											</div>
											<div class="users-details-box view-affiliate">
												{{ $TotalAffiliates[$affiliate->code] }} people
											</div>
										<div style="clear: both;"></div>
									</a>
								@else
									<a href="{{ route('MyAffiliate', $affiliate->code) }}">
										<div class="users-details-box">
											@if(!empty($affiliate->profile_logo))
												<div class="users-img" style="background-image: url({{ url($affiliate->profile_logo) }})"></div>
											@else
