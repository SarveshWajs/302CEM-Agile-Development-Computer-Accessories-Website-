...
<script type="text/javascript">
    ...
    jQuery(function($){
        ...
        try {
            ...
            var myDropzone = Dropzone.options.dropzone =
            {
               ...
               dictDefaultMessage :
                '<span class="bigger-150 bolder"><i class="ace-icon fa fa-caret-right red"></i> Drag & Drop </span> Uploads \
    ...
    var item = '<div class="form-group">\
                        ...
                        <div class="row">\
                            ...
                            <div class="col-md-2">\
                                <input type="input" name="unit_price[]" class="form-control" placeholder="Total Cost" onkeypress="return isNumberKey(event)">\
                            </div>\
                            <div class="col-md-2">\
