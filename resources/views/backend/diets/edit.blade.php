...
<script type="text/javascript">
  ...
  descriptionUrl = descriptionUrl.replace(':p_id', '{{ $diet->id }}');
  ...
  faqUrl = faqUrl.replace(':p_id', '{{ $diet->id }}');
  ...
  if(!faq){
    ...
    efficacyUrl = efficacyUrl.replace(':p_id', '{{ $diet->id }}');
    ...
    inspectionReportUrl = inspectionReportUrl.replace(':p_id', '{{ $diet->id }}');
