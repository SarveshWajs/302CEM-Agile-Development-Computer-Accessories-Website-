...
<h2 class="important-text">
	Set the monthly percentage of total sales that each agent can get 
</h2>
...
<hr>
<div class="form-group container-box">
	<label>Target Sales ≥ (RM)</label>
	<input type="text" class="form-control" name="target" placeholder="Target Sales" value="{{ isset($setting) ? $setting->target : '' }}" onkeypress="return isNumberKey(event)">
</div>
<hr>
<div class="row">
	<h3>Only apply to personal sales quantity</h3>
		...
		<div class="col-sm-3">
			...
			<div class="form-group container-box">
				...
				<div class="form-group">
					<label>Target (Items qty)</label>
					<input type="text" class="form-control" name="target_box[]" placeholder="Quantity of items target" 
...
<div class="form-group container-box">
	...
	<p><b>Each agent level can take a different percentage of total sales</b></p>
	<hr>
	<h3>Set Date</h3>

	<h4>If "Set Date" is <b>25</b>, Reward will auto update to agent's wallet on the 25th of every month</h4>

	<h4>If "Set Date" is <b>empty</b>, Reward will auto update to agent's wallet on every month end</h4>

	<hr>

	<h3>Target Sales</h3>
	<h4>If "Target Sales" is <b>10000</b>, Reward will auto update to agent's wallet if total sales more equal than 10000</h4>

	<h4>If "Target Sales" is <b>empty</b>, Reward will auto update to agent's wallet based on total sales</h4>

	<p>Example: </p>
	<p>This month total sales is <b>$10000</b> </p>
	<h3>Reward</h3>
	<ul>
		<li>Agent (1%) - All "Agent" level can get RM 100</li>
		<li>VIP (2%) - All "VIP" level can get RM 200</li>
		<li>Manager (3%)  - All "VIP" level can get RM 300</li>
		<li>CEO (4%) - All "VIP" level can get RM 400</li>
	</ul>
