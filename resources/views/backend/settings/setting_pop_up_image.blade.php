...
<div class="form-group">
	<div class="row">
		<div class="col-sm-12">
			...
			<div>
				<form method="POST" action="{{ route('uploadPopupImage') }}" class="dropzone well" id="dropzone" enctype="multipart/form-data">
					@csrf
					<div class="fallback">
...
<script type="text/javascript">
    ...
    $('.product-image-list').on('click', '.product-image-thumbnail .delete-image', function(e){
        ...
        if(confirm('Delete This Image?') == true){
            var url = '{{ route("DeletePopupImage", ":id") }}';
