...
<div class="profile-content">
	<div class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="col-2" align="center">
					<a href="{{ route('completed_order') }}" style="position: relative;">
						...
						<br>
						<span class="profile-word" style="font-weight: bold; text-decoration: underline;">{{ isset($data['lang']['lang']['completed']) ? $data['lang']['lang']['completed'] : 'Completed' }}</span>
					</a>
				</div>
		...
		<div class="myOrder-list">
				...
				@if(isset($ship_details[$transaction->id]) && $ship_details[$transaction->id] == 'Successfully Delivered' ||
